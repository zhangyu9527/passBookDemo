...
import com.zhangyu.passbook.passbook.mapper.PassTemplateRowMapper;
...
import com.zhangyu.passbook.passbook.vo.*;
...
public class InventoryServiceImpl  implements IInventoryService {
    ...
    private List<PassTemplate> getAvailablePassTemplate(List<String> excludeIds) {
        ...
        FilterList filterList = new FilterList(FilterList.Operator.MUST_PASS_ONE);//只需要通过一个过滤器
