...
import com.zhangyu.passbook.passbook.constant.PassStatus;
import com.zhangyu.passbook.passbook.dao.MerchantsDao;
import com.zhangyu.passbook.passbook.entity.Merchants;
import com.zhangyu.passbook.passbook.mapper.PassRowMapper;
import com.zhangyu.passbook.passbook.service.IUserPassService;
import com.zhangyu.passbook.passbook.vo.Pass;
import com.zhangyu.passbook.passbook.vo.PassInfo;
...
public class UserPassServiceImpl  implements IUserPassService {
    ...
    private Map<String , PassTemplate> buildPassTemplateMap(List<Pass> passes) throws Exception {
        ...
        //构造PassTemplateId -> PassTemplate Object de Map ,用于构造PassInfo
    ...
    /**
     *通过获取的Pass Template 对象构造MerchantsMap
     */
